...
embeddings = GoogleGenerativeAIEmbeddings(model = "models/embedding-001", google_api_key="AIzaSyCJ5f_6REcenTkKdCiPEIdVyYy6N85JrFs")
...
safety_settings1 = [
  {
    "category": "HARM_CATEGORY_HARASSMENT",
    "threshold": 0  # Change the threshold value to an integer
  },
  {
    "category": "HARM_CATEGORY_HATE_SPEECH",
    "threshold": 0
