...
def get_conversational_chain():
	...
	model = ChatGoogleGenerativeAI(model="gemini-pro", generation_config=generation_config, safety_settings=safety_settings1, google_api_key=os.getenv("GOOGLE_API_KEY"))
